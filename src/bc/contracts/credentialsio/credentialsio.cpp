...
class [[eosio::contract("credentialsio")]] credentialsio : public eosio::contract {

public:
  
  credentialsio(name receiver, name code, datastream<const char*> ds) : contract(receiver, code, ds) {}
...
EOSIO_DISPATCH(credentialsio, (create)(update)(remove)(like))