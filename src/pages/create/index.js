        ...
        <Col span={20}>
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Item label='Certificate type'>
              ...
              >
                <Radio.Button value={1}>Username&Password</Radio.Button>
                <Radio.Button value={2}>Identification</Radio.Button>
                <Radio.Button value={3}>Certificate</Radio.Button>
                <Radio.Button value={4}>Badge</Radio.Button>
                <Radio.Button value={5}>Trademark</Radio.Button>
                <Radio.Button value={6}>Others</Radio.Button>
              </Radio.Group>    
            </Form.Item>
            <Form.Item>
